...
var xml= new XMLHttpRequest();
  xml.open("GET","chat.php?from="+<?php echo $mobile ?>+"&to="+to+"&msg="+msg,true)
  xml.send();
  ...
  var to=document.getElementById("to").value;
  var xml= new XMLHttpRequest();
  xml.open("GET","get.php?from="+<?php echo $mobile ?>+"&to="+to,true)
  xml.send();
  xml.onreadystatechange=function(){
  if(xml.readyState==4&&xml.status==200)
  {
...
<div id="upp">
<a href="complaint.php"><span id ="regi">Register</span></a>
...
$sq = "SELECT * from user_complain WHERE mobile = '$mobile';";
...
?>
<option> <?php echo $policesn ?></option>
<?php
...
<?php
 ...
 $dbname="police_on_work";
$conn=mysqli_connect($hostname,$dbusername,$dbpassword,$dbname);
$sql = "SELECT * from user_complain WHERE Mobile = '$mobile'";
